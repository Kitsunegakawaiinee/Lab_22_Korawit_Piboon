...
{
    vector <int> for_return = {hpmax,atk,def};
...
void Unit::equip(Equipment *a){
	...
	{
		hpmax = hpmax - equipment->getStat()[0] + a->getStat()[0];
		atk = atk - equipment->getStat()[1] + a->getStat()[1];
		def = def - equipment->getStat()[2] + a->getStat()[2];
	}
	equipment = a;
